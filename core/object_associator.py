...
class ProductionMemoryBalancer:
    ...
    def __init__(
        ...
        """
        self.max_ram: float = max_allowed_ram_mb
        self.soft_ram: float = max_allowed_ram_mb * soft_ram_ratio
        self.gc_interval_base: int = max(100, force_gc_interval_frames)
        self.gc_interval_current: int = self.gc_interval_base

        self.frame_counter: int = 0
        self.last_hard_gc_ts: float = 0.0
        self.min_hard_gc_cooldown_sec: int = min_hard_gc_cooldown_sec
