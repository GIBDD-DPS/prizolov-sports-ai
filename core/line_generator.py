...
# Version: 3.04 (Combo Markets Analytics Core)
...
class BroadLineGenerator:
    """Математический движок для расчета динамических коэффициентов спортивной линии (Исходы, Тоталы, Форы, ИТ, Комбо)"""
    ...
    def calculate_poisson_line(self, 
        ...
        """
        Генерирует базовые и продвинутые комбинированные рынки на основе Пуассоновского распределения.
        """
        ...
        # Переменные для расчета комбинированного рынка: Исход + Тотал (П1+ТБ, П2+ТМ и т.д.)
        ...
        # Новое: Сборка комбинированных рынков (Исход + Тотал)
        ...
        return {
            ...
            "totals": totals + combo_markets, # Склеиваем комбо-исходы в общую линейку тоталов
            "handicaps": handicaps
        }
