...
### Fixed
- Restored production FastAPI wiring for `/api/v1` routers, CORS, static storefront, and parser scheduler startup.
- Aligned Docker/Amvera ASGI entrypoints with `app.main:app` and `/app/backend` import path.
