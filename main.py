...
# Version: 5.15 (Absolute Safe Arguments Default)
...
if __name__ == "__main__":
 ...
 # >>> НОВОЕ: Флаг для запуска в режиме мока (без подключения к Agent OS) <<<
 ...
 args.weights, 
 args.dashboard_port,
 args.mock_mode  # >>> Передаём флаг в основную функцию <<<
 ))
